    ...
    <main class="container-lg mt-5">
        ...
        <form class="col-sm-6 offset-sm-3" method="post" action="{{route('guardar-marca')}}" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" id="nombre" maxlength="150" required value="{{ old('nombre') }}">
          ...
          <div class="mb-3">
            ...
            <div class="row">
              <div class="col-10 offset-1 col-sm-7 offset-sm-0" id="contenedorFoto">
